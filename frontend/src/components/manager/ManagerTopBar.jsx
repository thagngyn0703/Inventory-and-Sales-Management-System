    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <div className="flex max-w-[min(100vw-8rem,620px)] items-center gap-1.5 rounded-full border border-white/30 bg-white/15 py-1 pl-1 pr-2 text-[11px] font-semibold text-white shadow-sm backdrop-blur-sm sm:gap-2 sm:pr-3">
          ...
          {storeName ? (
            <span className="hidden shrink-0 whitespace-nowrap rounded-md border border-white/35 bg-white/10 px-2 py-0.5 text-[10px] font-bold text-white sm:inline-flex sm:items-center">
              <i className="fa-solid fa-store mr-1 text-[9px] opacity-90" aria-hidden />
              {storeName}
            </span>
          ) : null}
          <span className="max-w-[160px] truncate sm:max-w-[180px]">{displayName}</span>

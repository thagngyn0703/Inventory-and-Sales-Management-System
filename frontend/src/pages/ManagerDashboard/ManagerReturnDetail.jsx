  ...
  return (
    <ManagerPageFrame showNotificationBell={false}>
      <StaffPageShell
        ...
        title={loading ? 'Đang tải…' : `Phiếu trả #${String(data?._id || '').slice(-8).toUpperCase()}`}
        subtitle="Chi tiết đối chiếu giữa hóa đơn mua và phiếu trả hàng."
        headerActions={
      ...
      >
        ...
        {loading && <p className="manager-products-loading">Đang tải dữ liệu…</p>}
        {!loading && !error && data && (
          <div className="grid gap-5">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="mt-2 border-t border-slate-100 pt-2 flex justify-between text-base">
